...
object MiscInfo_panama {
  ...
  implicit lazy val millBaseModuleInfo: _root_.mill.main.RootModule.Info = _root_.mill.main.RootModule.Info(
    ...
    _root_.mill.define.Discover[panama]
  )
}
import MiscInfo_panama.{millBuildRootModuleInfo, millBaseModuleInfo}
object panama extends panama
class panama extends _root_.mill.main.RootModule.Foreign(Some(_root_.mill.define.Segments.labels("foreign-modules", "depends", "chisel", "panama"))) {

//MILL_ORIGINAL_FILE_PATH=/home/runner/work/opengpu/opengpu/depends/chisel/panama.sc
