 ...
 *
 * This package contains the core RTL (Register Transfer Level) implementation
 * of the Open GPU architecture. It includes the main OGPU module and related
 * components for vector processing.
 */
package ogpu.rtl
 ...
 *
 * @param dLen Data path width in bits
 * @param extensions List of supported instruction set extensions
 * @param vrfBankSize Size of each bank in the Vector Register File
 */
case class OGPUParameter(
   ...
   *
   * @return Sequence of Instruction objects representing supported vector operations
   *         Excludes vector configuration instructions (vset*) and includes only
   *         instructions from the RVV (RISC-V Vector) extension
   */
 ...
 *
 * This object serves as a test harness for the OGPUParameter class,
 * demonstrating its usage and printing the supported instructions
 */
