 ...
 *
 * This package contains the main bundle definitions used throughout the OGPU core,
 * including task bundles, stack data structures, and commit data structures.
 */
package ogpu.core
 ...
 *
 * Represents a task to be executed by a compute unit, containing all necessary
 * state information for execution.
 *
 * @param threadNum Number of threads in the warp
 * @param warpNum Number of warps
 * @param dimNum Number of dimensions in vector operations
 * @param xLen Scalar register width in bits
 * @param dimWidth Vector dimension width in bits (default 16)
 */
class CuTaskBundle(
 ...
 *
 * Represents the state of a thread stack during divergence,
 * including masks and program counter information.
 *
 * @param threadNum Number of threads in the warp
 * @param addrBits Number of bits for address representation
 */
class StackData(
  threadNum: Int,  // Number of threads in the warp
 ...
 *
 * Contains the data needed for instruction commit, including
 * register write information and program counter state.
 *
 * @param xLen Scalar register width in bits
